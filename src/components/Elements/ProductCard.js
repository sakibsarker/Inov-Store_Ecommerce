...
const ProductCard = ({product}) => {
    const{id,name,overview,price,poster,rating,long_description,best_seller}=product;
  return (
...
<div className="w-full m-3 max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    <a href="#">
        <img className="p-8 rounded-t-lg object-cover" src={poster} alt="product image" />
    </a>{best_seller}
